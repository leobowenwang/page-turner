...
<div class="container">
    ...
    <p>
        This website is operated by Page Turner. Throughout the site, the terms “we”, “us”
        and “our” refer to Page Turner. Page Turner offers this website, including all
    ...
    or services that we offer. All descriptions of products or product pricing are subject to
    ...
    at the time the order was made. We reserve the right to limit or prohibit orders that, in
    ...
    to change or update information or cancel orders if any information in the Service or
    on any related website is inaccurate at any time without prior notice (including after
    ...
    federal, provincial or state regulations, rules, laws, or local ordinances; (d) to infringe
    ...
    national origin, or disability; (f) to submit false or misleading information; (g) to upload
    or transmit viruses or any other type of malicious code that will or may be used in any
    way that will affect the functionality or operation of the Service or of any related
    website, other websites, or the Internet; (h) to collect or track the personal information
    ...
    reserve the right to terminate your use of the Service or any related website for
    ...
    are (except as expressly stated by us) provided 'as is' and 'as available' for your use,
    ...
    In no case shall Page Turner, our directors, officers, employees, affiliates, agents,
    ...
    contract, tort (including negligence), strict liability or otherwise, arising from your use
    of any of the service or any products procured using the service, or for any other
    claim related in any way to your use of the service or any product, including, but not
    limited to, any errors or omissions in any content, or any loss or damage of any kind
    incurred as a result of the use of the service or any content (or product) posted,
    ...
    You agree to indemnify, defend and hold harmless Page Turner and our parent,
    ...
    due to or arising out of your breach of these Terms of Service or the documents they
    ...
    Favoritenstraße 226, Vienna, 9, 1100, Austria.
    <br><br>
